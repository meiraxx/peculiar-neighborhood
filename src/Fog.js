...
export default class Fog {
	...
	prepareObject() {
		...
		this.fogSprite0.x = -4096;
		this.fogSprite0.y = -2048;
		this.fogSprite0.scale.x *= 4;
		this.fogSprite0.scale.y *= 4;
		this.fogSprite1 = new PIXI.Sprite(fogTexture);
		this.fogSprite1.name = "fog1";
		this.fogSprite1.x = 0;
		this.fogSprite1.y = -2048;
		this.fogSprite1.scale.x *= 4;
		this.fogSprite1.scale.y *= 4;
	...
	fogLoop(delta, player) {
	  ...
	  this.fogSprite0.x = this.fogSprite0.x >= 4096 ? -4096 : this.fogSprite0.x;
	  
	  this.fogSprite1.x += 0.2;
	  this.fogSprite1.x = this.fogSprite1.x >= 4096 ? -4096 : this.fogSprite1.x;
		}
	}
}